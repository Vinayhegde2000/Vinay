...
<head>
    ...
    <title>Welcome to Veinn Bank</title>
...
<body style="background-image:url('statics/1.jpg'); padding-top:8%;">
...
<div id="container">
    ...
    <div class="container-large"
        style="color:white; height:500px; width: 100%; padding:8% 2% 2% 2%; background-image:"status/1.jpg;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> Veinn
                        Bank!</b></p>
            </div>
    ...
    <img src="statics/images.jfif" alt="" style="width:100%; position:absolute; z-index:-1">

    <center style="margin:80px 0px 20px 0px;">
        <div class="container"
            style="backdrop-filter: blur(10px); box-shadow:3px 3px 15px black; border-radius:30px; padding:20px 0px 20px 0px;">
            <h1 style="text-shadow:2px 2px 2px gray; color:white;"><b>Our Major Facilities</b></h1>
            <div class="container" style="margin:50px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
