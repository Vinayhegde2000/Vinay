...
<head>
    ...
    <title>About us - Veinn Bank</title>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
</head>

<body style="background-image:url('statics/2.jpg'); padding-top:8%;">
    ...
    <center>
        <div class="container" style="margin-top: 2%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/Vinay.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:blue; text-shadow:2px 2px 2px gray;">Vinay Hegde</h1>
            <p style="color:white;"><b>Intern at Sparks Foundation <br> New Horizon College Of Engineering</b></p>
    </center>
